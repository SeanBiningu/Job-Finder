    ...
    <div className="app-shell">
      <header className="topbar">
        ...
        <div className="top-actions">
          ...
          <button className="employer-button" onClick={async () => { await supabase?.auth.signOut(); setSignedIn(false); }}>Log out</button>
        </div>
      </header>
